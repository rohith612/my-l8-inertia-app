<template>
    <app-layout title="createProduct">
        <div class="max-w-6xl mx-auto py-8 sm:px-6 lg:px-8">
            <div class="block mb-6">
                <Link :href="route('products-master.index')"
                    ><svg
                    ...
                    >
                        ...
                        >
                            <div class="my-4 col-span-6 sm:col-span-4">
                                ...
                                >
                                    <div class="m-4">
                                        ...
                                        <jet-input-error
                                            :message="form.errors.picture_path"
                                            class="mt-2"
                                        />
                                    </div>
                                </div>
                            ...
                            <div class="my-4 col-span-6 sm:col-span-4">
                                ...
                                />
                                <span
                                    v-if="multipleImageValidationError"
                                        ...
                                        <div class="relative h-12 w-20">
                                            ...
                                            >
                                                <jet-secondary-button
                                                    ...
                                                    "
                                                    >Add
                                                    images</jet-secondary-button
                                                >
                                            </div>
                                        </div>

                                        <div
                                            class="my-4 flex flex-row space-x-4"
                                            v-show="photoPreviews.length"
                                        >
                                            <div
                                                class="
                                                    border-solid
                                ...
                                <jet-input-error
                                    :message="form.errors.additional_imgs"
                                    class="mt-2"
                                />
                            </div>
                            ...
                            <div class="my-4 col-span-6 sm:col-span-4">
                                ...
                                >
                                    ...
                                    <option
                                        v-for="(index, item) in categories"
                                        :key="index"
                                        :value="index"
                                    >
                                        {{ item }}
