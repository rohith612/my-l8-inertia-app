        ...
        <div class="h-16 flex items-center">
          ...
          <div class="ml-auto flex items-center">
            <div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
              <!-- <a href="#" class="text-sm font-medium text-gray-700 hover:text-gray-800">Sign ins</a> -->
                <Link :href="route('login')" class="text-sm font-medium text-gray-700 hover:text-gray-800">
                    Sign in
                </Link>
              <span class="h-6 w-px bg-gray-200" aria-hidden="true"></span>
              <!-- <a href="#" class="text-sm font-medium text-gray-700 hover:text-gray-800">Create account</a> -->
                <Link v-if="canRegister" :href="route('register')" class="text-sm font-medium text-gray-700 hover:text-gray-800">
                    Create account
                </Link>
            </div>
            ...
            <!-- <div class="hidden lg:ml-8 lg:flex">
              <a href="#" class="text-gray-700 hover:text-gray-800 flex items-center">
                <img src="https://tailwindui.com/img/flags/flag-ind.svg" alt="" class="w-5 h-auto block flex-shrink-0">
